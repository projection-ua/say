                    ...
                    <form className={s.subscribeForm}>
                        ...
                        <button type="submit">
                            <svg className={s.submitIcon} xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 25" fill="none">
                                <path d="M18.0324 0.682129L16.0887 2.6016L24.738 11.1429L0.000488281 11.1429L0.000488281 13.8574L24.738 13.8574L16.0887 22.3986L18.0324 24.3181L30 12.5001L18.0324 0.682129Z" fill="#FFFEFC" fill-opacity="0.5"/>
                            </svg>
                        </button>
                    </form>
                </div>
