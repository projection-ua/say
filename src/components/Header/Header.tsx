                ...
                <div className={s.container}>
                    <div className={s.topBar}>
                        ...
                        <div className={s.left}>
                            ...
                            <span className={s.phone}>+38 (096) 121 25 25</span>
                        </div>
                        ...
                        <div className={s.right}>
                            ...
                            <div className={s.iconBlock} onClick={() => setWishlistOpen(true)}>
                                <svg className={s.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 22" fill="none">
                            ...
                            <div className={s.iconBlock} onClick={handleOpenCart}>
                                <svg className={s.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 24" fill="none">
                    ...
                    <nav className={s.navBar}>
                        {loading ? (
                            ...
                            <ul className={s.menu}>
                                <li><Link to="/sales">АКЦІЇ ТА ЗНИЖКИ</Link></li>
                                <li>
                                    <Link to="/new">
                                                    ...
                                                    <ul className={`${s.submenu} ${activeSubmenuId === parent.id ? s.active : ''}`}>
                                                        <div className={s.contentSubMenu}>
                                                            <div className={s.itemsSubMeny}>
                                                                {children.map((child) => (
                                                                    <li key={child.id}>
                                                                        <Link to={convertUrl(child.url)}>{child.title}</Link>
                                                                    </li>
                                                                ))}
                                                            </div>
